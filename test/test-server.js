...
describe('Recipes', function() {
    ...
    //  status code and that the returned object has an `id`
    it('should add an item on POST', function() {
        const newItem = { name: 'chocolate milkshake', ingredients: ['2 cups vanilla ice cream', '1/2 cup chocolate sauce'] };
        return chai.request(app)
            .post('/recipes')
            .send(newItem)
            .then(function(res) {
    ...
    it('should update items on PUT', function() {
        ...
        const updateData = {
            name: 'beef stew',
            ingredients: ['1 lb beef', '3 cups broth', '1 stalk celery', '1 cup carrots']
        };
